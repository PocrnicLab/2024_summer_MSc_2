...
write.table(cnvr_data, "/exports/cmvm/eddie/eb/groups/PocrnicLab/2024_ms_cnv/Wkdir/06_performance_assessment/cnvr_mac_data_with_id_2.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
ggsave("/exports/cmvm/eddie/eb/groups/PocrnicLab/2024_ms_cnv/Wkdir/06_performance_assessment/cnvr_mac_plot_2.png", plot, width = 10, height = 6, dpi = 300)
